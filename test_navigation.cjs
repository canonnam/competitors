...
test('aliases, Korean spacing and case insensitive multiword searches identify the right tool',()=>{
  for(const [query,id] of [['손익','operating-costs'],['월급','payroll'],['SEO','search-visibility'],['근로 계약서','payroll'],['ｓｅｏ','search-visibility'],['네이버 광고','naver-ads'],['UIUX','competitor-uiux'],['화면 비교','competitor-uiux'],['UXTEST','competitor-uiux']]) {
