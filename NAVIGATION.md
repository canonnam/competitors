...
- Seven transparent Icons8 3D Fluency icons live in `assets/icons/fluency/`; `SOURCES.md` records their original URLs and attribution terms. All internal pages include an Icons8 credit. Icons appear in category menus and tag-shaped favorites controls; content titles and search results are text-only, apart from unread N badges.
