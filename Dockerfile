...
COPY claim_check.py claim-check.html app.py naver_ads.py competitor_news.py wiki_chat.py agency_news.py business_support.py support_feedback.py search_visibility.py reputation_watch.py index.html competitors.html competitor-uiux.html competitor-news.html agency-news.html ai-hub-data.html naver-ads.html search-visibility.html reputation-watch.html operating-costs.html borrowing-status.html nearby-facilities.html statistics.html knowledge.html facility-acquisition.html /app/
...
COPY staff_eval.py staff-eval.html staff-eval-session.html /app/
